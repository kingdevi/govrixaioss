...
impl PolicyEngine {
    ...
    pub fn evaluate(&self, event: &govrix_ai_oss_common::models::AgentEvent) -> PolicyDecision {
    ...
    fn matches_all_conditions(
        &self,
        event: &govrix_ai_oss_common::models::AgentEvent,
    ...
    fn get_field_value(&self, event: &govrix_ai_oss_common::models::AgentEvent, field: &str) -> String {
        match field {
...
mod tests {
    use super::*;
    use govrix_ai_oss_common::models::event::{EventDirection, Provider};
    use uuid::Uuid;

    fn make_event() -> govrix_ai_oss_common::models::AgentEvent {
        govrix_ai_oss_common::models::AgentEvent::new(
            "agent-001",
            Uuid::now_v7(),
