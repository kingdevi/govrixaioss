...
pub async fn list_reports() -> impl IntoResponse {
    ...
    Json(json!({
        "data": [],
        "total": 0,
        "note": "Report persistence is available in Govrix AI OSS SaaS — see Govrix AI OSS.io",
    }))
}
    ...
    (
        ...
        Json(json!({
            "data": {
                ...
                "note": "Full report generation with PDF export available in Govrix AI OSS SaaS — see Govrix AI OSS.io",
            }
        })),
    )
}
