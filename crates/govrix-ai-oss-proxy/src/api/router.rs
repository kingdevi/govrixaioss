...
/// the Govrix AI OSS REST API every 5 seconds. No build step or Node.js required.
...
async fn metrics_handler(State(state): State<Arc<AppState>>) -> impl IntoResponse {
    ...
    let body = format!(
        "# HELP govrix_ai_oss_requests_total Total proxy requests intercepted\n\
         # TYPE govrix_ai_oss_requests_total counter\n\
         govrix_ai_oss_requests_total {requests}\n\
         # HELP govrix_ai_oss_events_total Total events written to PostgreSQL\n\
         # TYPE govrix_ai_oss_events_total counter\n\
         govrix_ai_oss_events_total {events}\n\
         # HELP govrix_ai_oss_agents_active Distinct agents seen since process start\n\
         # TYPE govrix_ai_oss_agents_active gauge\n\
         govrix_ai_oss_agents_active {agents}\n"
    );
...
async fn metrics_stub_handler() -> impl IntoResponse {
    (
        ...
        "# HELP govrix_ai_oss_requests_total Total proxy requests intercepted\n\
         # TYPE govrix_ai_oss_requests_total counter\n\
         govrix_ai_oss_requests_total 0\n\
         # HELP govrix_ai_oss_events_total Total events written to PostgreSQL\n\
         # TYPE govrix_ai_oss_events_total counter\n\
         govrix_ai_oss_events_total 0\n\
         # HELP govrix_ai_oss_agents_active Distinct agents seen since process start\n\
         # TYPE govrix_ai_oss_agents_active gauge\n\
         govrix_ai_oss_agents_active 0\n",
    )
}
...
mod tests {
    #[test]
    fn dashboard_html_contains_govrix_ai_oss() {
        let html = include_str!("../../static/dashboard.html");
        assert!(html.contains("Govrix AI OSS"));
