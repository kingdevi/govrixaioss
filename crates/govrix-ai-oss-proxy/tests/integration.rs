//! Integration tests for the Govrix AI OSS proxy.
//!
...
mod tests {
    ...
    fn config_loads_defaults() {
        let cfg = govrix_ai_oss_common::config::Config::default();
    ...
    fn event_channel_creates_without_panic() {
        let (sender, _rx) = govrix_ai_oss_proxy::events::create_channel();
