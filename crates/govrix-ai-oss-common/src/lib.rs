//! Govrix AI OSS Common — shared types, models, protocols, and configuration.
//!
//! This crate is the foundation for all other Govrix AI OSS crates. It defines:
...
pub use errors::GovrixAIOSSError;
